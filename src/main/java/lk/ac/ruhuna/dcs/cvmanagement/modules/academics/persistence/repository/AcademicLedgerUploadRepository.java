...
public interface AcademicLedgerUploadRepository extends
        JpaRepository<AcademicLedgerUploadEntity, UUID>,
        JpaSpecificationExecutor<AcademicLedgerUploadEntity> {
