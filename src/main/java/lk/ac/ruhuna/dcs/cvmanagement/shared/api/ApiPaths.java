...
public final class ApiPaths {
    ...
    public static final String ADMIN_SHORTLISTS = API_V1 + "/admin/shortlists";
    public static final String ADMIN_ELIGIBLE_STUDENTS = API_V1 + "/admin/eligible-students";
    public static final String ADMIN_EXPORTS = API_V1 + "/admin/exports";
